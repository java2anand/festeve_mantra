                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                @foreach($arrEventOrganiser  as $organiser)
                                <tr>
                                    ...
                                    <td width="10%">
                                        <div class="btn-group">
                                            <a href="{{ url('admin/eventorganiser_add',$organiser->id) }}" data-toggle="tooltip" title="" class="btn btn-sm btn-success" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                        </div>
                                        <div class="btn-group">
