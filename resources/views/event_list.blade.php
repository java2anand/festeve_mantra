			...
			<div class="col-xs-12">
				<ul>
					...
					<li class="listing_page_mid_section">
						<div class="listing_page_mid_section_outer">
							...
							<div class="listing_page_mid_section_right">
								<p class="listing_mid_category_date">
									...
									<span class="text-right">March 17, 2017 | Delhi</span>
								</p>
								<h3><a href="#">Arient Event by CCL Pvt. ltd.</a></h3>
								<p class="listing_mid_category_info">dummy text goes here dummy text goes here dummy text
									again goes here dummy text goes here dummy text goes
									dummy text again goes here...
								</p>
						...
						</div><div class="listing_page_mid_section_outer">
							<div class="listing_page_mid_section_left">
								<a href="#"></a>
							</div>
							<div class="listing_page_mid_section_right">
